...
import { LayoutDashboard, BookOpenCheck, FileCheck2, Award } from 'lucide-react';
...
export function EmployeeSidebar() {
  ...
  const navItems = [
    ...
    { name: 'Induction Course', href: '/employee/learn', icon: BookOpenCheck },
    { name: 'Final Assessment', href: '/employee/assessment', icon: FileCheck2 },
    { name: 'My Certificate', href: '/employee/certificate', icon: Award },
  ];
